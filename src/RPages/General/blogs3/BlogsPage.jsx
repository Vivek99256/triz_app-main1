...
const blogData = [
  {
    image:
      "/Resources_Images/Article_Image_1.png",
  ...
  {
    image:
      "/Resources_Images/Article_Image_3.png",
...
export default function BlogsPage() {
  return (
    <div className="flex flex-col items-center lg:mt-10 lg:mb-10 sm:mb-10">
      <div className="flex flex-wrap gap-5 justify-between mt-9 lg:px-20 sm:px-4 w-full max-w-screen-2xl max-md:max-w-full">
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col justify-center self-stretch py-0.5 my-auto lg:w-[35px] sm:w-[15px]">
            <div className="shrink-0 h-0.5 lg:border-2 sm:border-2 border-solid bg-zinc-800 border-zinc-800" />
          </div>
        </div>
