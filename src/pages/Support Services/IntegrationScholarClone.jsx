...
<>
      ...
      <div className="hero-content flex flex-col lg:flex-row items-center lg:justify-between w-full">
            <div className="flex flex-col w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              ...
              <h1 className="lg:mr-10 lg:ml-5 lg:text-3xl sm:text-2xl sm:text-center lg:text-left font-bold text-sky-500 max-md:mr-2.5 max-md:max-w-full max-md:text-4xl">
                Streamlined School Management: <br />
                  <span className="text-amber-500">From Onboarding to Rollover</span>
                </h1>
            ...
            <div className="lg:flex sm:hidden flex-col ml-20 w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              <img loading="lazy" src="/supportservice_images/image.png" alt="School integration illustration" className="object-contain w-full aspect-[1.29] max-md:mt-6 max-md:max-w-full" />
            </div>
          </div>
        </section>
        <Services />
