...
function ScrollToTop() {
  ...
  return (
    ...
    <button 
      ...
      className="flex flex-col justify-center items-center mb-5 px-2.5 mt-8 bg-white rounded-full h-[40px] shadow-[0px_0px_15px_rgba(0,0,0,0.3)] w-[40px] max-md:mt-6"
