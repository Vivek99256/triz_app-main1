        ...
        <div className="hero-content flex flex-col lg:flex-row items-center lg:justify-between w-full">
              <div className="flex flex-col w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col mt-6 w-full max-md:max-w-full">
                  <h1 className="lg:mr-10 lg:ml-5 lg:text-[32px] sm:text-2xl sm:text-center lg:text-left font-bold text-sky-500 max-md:mr-2.5 max-md:max-w-full max-md:text-4xl">
              ...
              <div className="lg:flex sm:hidden flex-col ml-20 w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
                <img loading="lazy" src="/PI 3/image.png" alt="School integration illustration" className="object-contain w-full aspect-[1.29] max-md:mt-6 max-md:max-w-full" />
              </div>
            </div>
          </section>
          <Services />
