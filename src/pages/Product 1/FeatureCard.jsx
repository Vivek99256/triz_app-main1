...
export default function FeatureCard({ icon, title, description }) {
  return (
    <div className="flex flex-col grow items-start px-5 py-8 w-full font-medium bg-white rounded-lg border-2 border-cyan-900 border-solid text-neutral-800 max-md:mt-10 max-md:max-w-full">
      <img
        loading="lazy"
        src={icon}
