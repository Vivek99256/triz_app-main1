      ...
      <div className="hero-content flex flex-col lg:flex-row items-center lg:justify-between w-full">
            <div className="flex flex-col w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col mt-6 w-full max-md:max-w-full">
                ...
                <span className="text-amber-500">From Rights to Workflow</span>
                </h1>
            ...
            <div className="lg:flex sm:hidden flex-col ml-20 lg:-mt-28 w-full lg:w-6/12 max-md:ml-0 max-md:w-full">
              <img loading="lazy" src="/PI 1/image.png" />
            </div>
          </div>
        </section>
        <Services />
