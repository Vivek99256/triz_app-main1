...
import studentImage from '../../../public/commservice_images/Group 168.png';
import featureImage1 from '../../../public/commservice_images/feature1.png';
import featureImage2 from '../../../public/commservice_images/feature2.png';
      ...
      <div className="hero-content flex flex-col lg:flex-row items-center lg:justify-between w-full">
        <div className="text-content w-full lg:w-6/12 mb-8 lg:text-left lg:mb-0 lg:ml-8 sm:text-center"> {/* Add left margin here */}
          <h1 className="lg:text-5xl sm:text-2xl font-bold mb-5">
            <span className="text-blue-600">Seamless Communication,</span> <br />
            <span className="text-orange-500">Stronger Connections</span>
          </h1>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <Image src={feature.image} alt={`Feature ${index + 1}`} width={90} height={65} className="sm:flex lg:hidden object-cover" />
