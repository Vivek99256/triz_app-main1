...
import studentImage from '../../../public/analytics_images/Group 169.png';
import featureImage1 from '../../../public/analytics_images/feature1.png';
import featureImage2 from '../../../public/analytics_images/feature2.png';
import featureImage3 from '../../../public/analytics_images/feature3.png';
import featureImage4 from '../../../public/analytics_images/feature4.png';
...
const features = [
  {
    title: 'Tracking Progress with Precision',
    image: featureImage1,
    serviceComponent: <S1 />,
  ...
  {
    title: 'Unlocking Data-Driven Decisions',
    image: featureImage2,
    serviceComponent: <S2 />,
  ...
  {
    title: 'Sharpening Academic Outcomes',
    image: featureImage4,
    serviceComponent: <S4 />,
      ...
      <div className="hero-content flex flex-col lg:flex-row items-center lg:justify-between w-full">
        <div className="text-content w-full lg:w-6/12 mb-8 lg:text-left lg:mb-0 lg:ml-8 sm:text-center"> {/* Add left margin here */}
          <h1 className="lg:text-5xl sm:text-2xl font-bold mb-5">
            <span className="text-blue-600">Unlocking Success with,</span> <br />
            <span className="text-orange-500">Smart Analytics</span>
          </h1>
      ...
      <div className="key-features w-full mt-16">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {features.map((feature, index) => (
            ...
            >
              <h3 className="lg:text-sm sm:text-xs font-semibold text-center mb-4">{feature.title}</h3>
              <Image src={feature.image} alt={`Feature ${index + 1}`} width={150} height={80} className="lg:flex sm:hidden object-cover w-full h-32" />
              <Image src={feature.image} alt={`Feature ${index + 1}`} width={150} height={90} className="sm:flex lg:hidden object-cover" />
