  ...
  const features = [
    {
      ...
      description: "Manage resources across one or multiple campuses in a single system."
    },
    {
      title: "Vendor & Purchase Orders",
      description: "Streamline procurement with easy-to-use purchase order management and vendor tracking."
    },
    {
      title: "Stock In/Out Logs",
      description: "Record every inventory movement for transparency and accountability."
    },
    {
...
<div className="flex overflow-hidden relative flex-col justify-center items-center items-end w-full max-md:pl-5 max-md:max-w-full"style={{
  ...
  <div className="flex overflow-hidden flex-col pt-20 max-w-full h-full bg-white bg-opacity-0 w-[600px] max-md:px-5 max-md:pb-24">
    ...
    Simplify Your School&rsquo;s Inventory Management
    </h1>
